import { HeroSection } from "../../snippets/components/hero-section";
import { PremiumButton } from "../../snippets/button.example";

export function Hero() {
  return (
    <HeroSection
      auroraColors={["#6366f1", "#8b5cf6", "#22d3ee"]}
      eyebrow={
      ...
      subheading={
        <p className="max-w-xl text-lg text-white/70">
          ...
          straight into your tracker — so the fifteen minutes after every meeting go back
          to being yours.
        </p>
      }
      actions={
